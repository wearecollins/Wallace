...
var ChanneledBlendShader = function(params)
{
	...
	var fragNoAlpha = [
		...
		'	vec2 colorUv = vUv * vec2(1., .5) + vec2(0., 0.5);',

		'	vec4 c = texture2D(currentTex, colorUv + vec2(0.,currentUOffset));',
		'	vec4 p = texture2D(previousTex, colorUv + vec2(0.,previousUOffset));',
